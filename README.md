...
The main script performs the following pre-ingest tasks for audiovisual material intended for the Interim Storage Repository (LIB-AV): 
...
Secondary script copies files to a new directory and adds a suffix to filenames using a csv to match.
